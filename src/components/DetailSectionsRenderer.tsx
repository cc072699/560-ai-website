...
interface DetailSectionsRendererProps {
  sections: PageSection[];
  productId?: string;
  productName?: string;
}

export default function DetailSectionsRenderer({ 
  sections, 
  productId = '', 
  productName = '' 
}: DetailSectionsRendererProps) {
  return (
    <div className="flex flex-col w-full">
      {sections.map((section) => {
        if (section.type === 'hero') return <DetailHero key={section.id} section={section} productId={productId} productName={productName} />;
        ...
        if (section.type === 'caseFaq') return <DetailCaseFaq key={section.id} section={section} />;
        return null;
      })}
    </div>
  );
...
function DetailCapabilities({ section }: { section: PageSection }) {
  ...
  if (!caps) return null;
  return (
    <div className="py-16 bg-white relative overflow-hidden border-b border-gray-100 text-left">
...
function DetailScenarios({ section }: { section: PageSection }) {
  ...
  return (
    <div className="py-16 bg-slate-50/50 border-b border-gray-100 relative overflow-hidden text-left">
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        <div className="text-center mb-16">
            ...
            <div key={idx} className="bg-white rounded-2xl border border-gray-150 overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col h-full text-left">
              <div className="bg-slate-100 relative overflow-hidden border-b border-gray-100 flex items-center justify-center min-h-[180px]">
                {item.imageUrl ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-gray-300 gap-1 bg-gray-55">
...
function DetailArchitecture({ section }: { section: PageSection }) {
  ...
  if (!arch) return null;
  return (
    <div className="py-16 bg-white relative overflow-hidden border-b border-gray-100 text-center">
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        <div className="text-center mb-16">
    ...
    <div className="py-16 bg-slate-50/50 border-b border-gray-100 relative overflow-hidden text-center">
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="max-w-3xl mx-auto border border-gray-200/80 rounded-2xl overflow-hidden shadow-2xl bg-slate-950 relative aspect-video flex items-center justify-center">
          {!video.videoUrl ? (
            <div className="w-full h-full flex flex-col items-center justify-center text-gray-400 gap-2 bg-slate-955">
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="overflow-x-auto rounded-3xl border border-gray-200/80 bg-white shadow-xl max-w-4xl mx-auto">
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="bg-slate-55 border-b border-gray-200 text-gray-700">
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center text-left">
          <div className="lg:col-span-7 bg-slate-900 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl flex flex-col">
            <div className="bg-slate-950 px-4 py-3 flex gap-1.5 items-center border-b border-slate-800 shrink-0">
            ...
            <div className="flex-grow relative bg-slate-950 flex items-center justify-center min-h-[300px] max-h-[600px]">
              {canv.imageUrl ? (
                ...
                <div className="text-slate-500 flex flex-col items-center gap-2">
                  <ImageIcon className="w-10 h-10 opacity-30 text-slate-350" />
          ...
          {part.items.map((item, idx) => (
            <div key={idx} className="flex items-center justify-center opacity-70 hover:opacity-100 transition-opacity duration-300">
              {item.logoUrl ? (
                ...
                <div className="text-xs font-bold text-gray-405 bg-slate-50 border border-gray-150 px-4 py-2 rounded-xl shadow-sm">
                  {item.name}
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto text-left">
          {cov.items.map((item, idx) => (
            <div key={idx} className="group p-6 border border-gray-150 rounded-3xl bg-slate-50/20 hover:bg-blue-50/5 hover:border-blue-150 transition-all duration-300 flex flex-col justify-between shadow-sm">
              ...
              <div className="border-t border-slate-105 pt-4 mt-4 text-xs text-gray-500 space-y-1 pl-7 font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 flex justify-center items-end relative min-h-[260px] md:min-h-[360px] bg-slate-50/50 rounded-3xl border border-gray-100 p-8">
            ...
            <div className="w-[38%] max-w-[200px] bg-slate-900 rounded-xl border border-slate-700/85 shadow-2xl p-1.5 select-none absolute right-4 bottom-4 z-20 transition-transform hover:translate-y-[-4px] duration-300">
              <div className="aspect-[3/4] bg-slate-950 rounded-md flex items-center justify-center text-[10px] text-slate-500 overflow-hidden relative border border-slate-800">
                {md.tabletUrl ? (
                  // eslint-disable-next-line @next/next/no-img-element
            ...
            <div className="w-[22%] max-w-[120px] bg-slate-900 rounded-xl border border-slate-700/90 shadow-2xl p-1 select-none absolute left-6 bottom-4 z-30 transition-transform hover:translate-y-[-4px] duration-300">
              <div className="aspect-[9/16] bg-slate-950 rounded-lg flex items-center justify-center text-[8px] text-slate-550 overflow-hidden relative border border-slate-800">
                {md.mobileUrl ? (
                  // eslint-disable-next-line @next/next/no-img-element
...
function DetailHardwareSpec({ section }: { section: PageSection }) {
  ...
  if (!hw) return null;
  return (
    <div className="py-16 bg-gradient-to-b from-white via-slate-50 to-white border-b border-gray-100 relative overflow-hidden text-left">
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto mt-10 text-left">
          {hw.annotations.map((ann, idx) => (
            ...
            >
              <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-50 to-indigo-600 opacity-80 group-hover:opacity-100 transition-opacity" />
...
function DetailTechStack({ section }: { section: PageSection }) {
  ...
  if (!ts) return null;
  return (
    <div className="py-16 bg-white border-b border-gray-100 relative overflow-hidden text-center">
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto space-y-4">
...
function DetailSandbox({ section }: { section: PageSection }) {
  ...
  return (
    <div className="py-16 bg-slate-50/50 border-b border-gray-100 text-left">
              ...
              {sb.tabs.map((tab, idx) => (
                <label
                  ...
                  className={`px-3.5 py-1.5 text-xs font-bold rounded-lg cursor-pointer transition-all select-none border border-transparent
                    ...
                    ${idx === 3 ? 'peer-checked/sbtab3:bg-white peer-checked/sbtab3:text-blue-655 peer-checked/sbtab3:border-gray-200 peer-checked/sbtab3:shadow-sm' : ''}
                    ${idx === 4 ? 'peer-checked/sbtab4:bg-white peer-checked/sbtab4:text-blue-655 peer-checked/sbtab4:border-gray-200 peer-checked/sbtab4:shadow-sm' : ''}
                    ${idx === 5 ? 'peer-checked/sbtab5:bg-white peer-checked/sbtab5:text-blue-655 peer-checked/sbtab5:border-gray-200 peer-checked/sbtab5:shadow-sm' : ''}
...
function DetailSignalWave({ section }: { section: PageSection }) {
  ...
  if (!sw) return null;
  return (
    <div className="py-16 bg-slate-900 text-white border-b border-gray-950 relative overflow-hidden text-center rounded-2xl">
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto space-y-4">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">{sw.title}</h2>
          {sw.subtitle && (
            <p className="text-sm md:text-base text-slate-400 leading-relaxed font-light">{sw.subtitle}</p>
          )}
          <div className="w-12 h-1.5 bg-blue-600 rounded-full mx-auto mt-4" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-8">
          <div className="p-6 border border-slate-800 rounded-2xl bg-slate-950/40 space-y-3 relative select-none text-left">
          ...
          <div className="p-6 border border-blue-900/60 rounded-2xl bg-blue-950/15 space-y-3 relative select-none shadow-2xl text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto text-left">
          {bg.items.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`group relative rounded-3xl border border-gray-150/70 shadow-sm overflow-hidden bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-505 flex flex-col ${spanClass} ${
              ...
              >
                {item.imageUrl ? (
                  ...
                  <div className="relative w-full bg-gradient-to-br from-slate-100 to-slate-50 flex-shrink-0 flex items-center justify-center" style={{ height: '50%', minHeight: '160px' }}>
                    ...
                    <span className="absolute top-4 left-4 text-[11px] font-bold text-gray-550 bg-white/80 backdrop-blur-sm border border-gray-200 px-2.5 py-1 rounded-full">
                      特性 0{idx + 1}
                    </span>
                  </div>
                )}
...
// ==========================================
// Case Study Specific Subcomponents
// ==========================================

export function DetailCaseOverview({ section }: { section: PageSection }) {
...
export function DetailCaseChallenges({ section }: { section: PageSection }) {
...
export function DetailCaseComparison({ section }: { section: PageSection }) {
...
export function DetailCaseStructure({ section }: { section: PageSection }) {
...
export function DetailCaseFaq({ section }: { section: PageSection }) {
