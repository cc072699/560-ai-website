      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-150 px-8 flex items-center justify-between shrink-0 shadow-sm relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500 font-medium">企业官网内容管控制</span>
          </div>

          <div className="flex items-center gap-4">
            {/* Glowing active environment indicator */}
            <div className="flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-3.5 py-1 text-xs text-blue-700 font-semibold shadow-sm">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="text-left hidden sm:block">
                <p className="text-xs font-bold text-slate-800 leading-tight">系统管理员</p>
                <p className="text-[9px] text-slate-400 font-semibold uppercase tracking-wider mt-0.5">Super Admin</p>
              </div>
            </div>
          </div>
        </header>
